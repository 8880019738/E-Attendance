...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
                <div id="menuwrap">
                    <ul id="menu">
                        ...
                        <span style="cursor: default;" onclick="document.getElementById('adminpopup').style.display='block'"><li><a>Admin</a></li></span>
                    </ul>
                </div>
            </div>
            </div>
        <div class="wrapper">
            <div id="content">
                <div style="width: 950px; height: 321px">
                    <h3 align="left">Administrator Login Error</h3><br>
                    <h4 align="left"><font color="Red">Invalid Username or Password</font></h4>
		</div>
            </div>
        </div>
