    ...
    %>
        ...
        <div class="wrapper">
                <div id="menuwrap">
                    <ul id="menu">
                        ...
                        <li><a href="AdminTimeTablePage.jsp">Timetable</a></li>
        ...
        <div class="wrapper light">
            <div id="content">
                <div style="width: 950px; height: 321px;color: white;">
                    <h3 align="left" style="font-size: 30px;margin: 50px 0px 0px 50px;color: black;">Welcome TO Faculty Page, Please Click On Faculty To Continue..</h3>	
                </div>
            </div>
        </div>
        ...
        <div id="logfaculty">
            <form>
                    ...
                    <h1>Welcome To Faculty Data Handling Page...</h1>
                    </div>
            </form>
        </div>
        </div>
	    ...
	    <tr>
	      <td>
		<input name="t5" type="text" placeholder="DOB(dd--Min-yyyy)" id="textb1"/></td>
	      <td>
		<input name="t6" type="text" size="20" placeholder="DDepartment" id="textb1"/></td>
        </tr>
	    <tr>
	      <td>
		<input name="t7" type="text" placeholder="Username" id="textb1"/></td>
	      <td>
		<input name="t8" type="text" placeholder="Password" id="textb1"/></td>
        </tr>
        <tr>
          <td>
        ...
        <div id="logfaculty">
            <form action="DeleteFaculty">
                    ...
                    <div id="logcon">
                    <span onclick="document.getElementById('deletefaculty').style.display='none'" id="close">&times;</span>
                    <h3 align="left">Faculty Deletion Form!</h3>
				<table>
					<tr>
                                            <br/>
                                            <br/>
						...
						<td>
						<input type="text"id="textb" name="t1"/> </td>
					</tr>
					
					<tr>
						<td class="message">&nbsp;</td>
						<td colspan="3"><input type="submit" value="Delete" id="button" /></td>
					</tr>
					</table>
                    </div>
            </form>
        ...
        <div id="modifyfaculty">
        <div id="logfaculty">
            <form action="ModifyFaculty.jsp">
                    <div id="loglogo">
                        <img src="images/logo.JPG"/>
                        <ul id="list">
                            <span style="cursor: default;" onclick="document.getElementById('addfaculty').style.display='block';document.getElementById('facultypopup').style.display='none';"><li><a href="#">Add Faculty</a></li></span>
                    ...
                    <div id="logcon">
                    <span onclick="document.getElementById('modifyfaculty').style.display='none'" id="close">&times;</span>
                    <h3 align="left">Faculty Modification Form!</h3>
				<table>
					<tr>
                                            <br/>
                                            <br/>
					...
					<tr>
						<td class="message">&nbsp;</td>
						<td colspan="3"><input type="submit" value="Modify" id="button" /></td>
					</tr>
					</table>
                    </div>
            </form>
