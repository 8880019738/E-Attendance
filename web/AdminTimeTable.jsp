...
<html>
    ...
    %>
        ...
        <div class="wrapper">
                <div id="menuwrap">
                    <ul id="menu">
                        <li><a href="AdminFacultyPage.jsp">Faculty</a></li></span>
       ...
       <%
                ...
                {
                    msg = "Oops Some Database Error Please Do Check and Add New Time Table";
                }
                else if(msg.equals("ModifyError"))
                {
                    msg = "Time Table Does Not Exist";
                }
                ...
                {
                    msg = "Time Table Modified Successfully";
                }
                ...
                {
                    msg = "Time Table Was Not Deleted";
                }
        %>
				<h3><%=msg%></h3>
