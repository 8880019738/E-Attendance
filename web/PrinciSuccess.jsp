...
<html>
    ...
    %>
        ...
        <div class="wrapper light">
            <div id="content">
                <h1 style="width: 950px; height: 321px;margin: 40px 0px 0px 40px;font-size: 25px">Principal Login SuccessFul</h1>
            </div>
        </div>
        ...
        <div id="logfaculty">
            <form action="AddDepart">
                    ...
                    <div id="logcon">
                    <span onclick="document.getElementById('departmentpopup').style.display='none'" id="close">&times;</span>
                    <table>
                        <h1>Enter The Below Details!</h1>
                        <tr>
                            <td><input type="text" name="t1" placeholder="Department Code" id="textb"/></td>
                        </tr>
                        <tr>
                            <td><input type="password" name="t2" placeholder="Password" id="textb"/></td>
                        </tr>
                            <tr>
